...
* You will have ~7-9 minutes to present and ~1.5 minutes to answer a quick question or two per presentation.
* Everyone will be presenting from one laptop in the front of their studio. You should upload your slides to the [shared Google Drive folder]({{ site.data.course.urls.final_project_shared_folder }}) beforehand. Acceptable formats are PowerPoint, PDF, and Google presentation.
