...
class WorldController:
    ...
    def handle_mouse_down(self, event):
        ...
        for con in self.children:
            con.handle_mouse_down(event, (x, y))
...
views = list(map(LeftBallView, balls)) + list(map(RightBallView, balls))

world_controller = WorldController([BallController(ball) for ball in balls])
